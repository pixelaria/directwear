...
/* fashion-store/template/common/cart.twig */
class __TwigTemplate_b87a1902483607e7d42fed579d3c9a7cdd7f51892eb2ccc9451063bf33dc77c1 extends Twig_Template
{
  ...
  <button type=\"button\" data-toggle=\"dropdown\" data-loading-text=\"";
        ...
        echo "\" class=\"dropdown-toggle btn\"><img src=\"image/catalog/header/cart.png\"> <span id=\"cart-total\">";
...
";
    ...
    {
        return "fashion-store/template/common/cart.twig";
    }
...
/*   <button type="button" data-toggle="dropdown" data-loading-text="{{ text_loading }}" class="dropdown-toggle btn"><img src="image/catalog/header/cart.png"> <span id="cart-total">{{ text_items }}</span></button>*/
/*   <ul class="dropdown-menu dropdown-menu-right pull-right">*/
...
/*           {% endfor %}*/
/*         </table>*/
/*         <p class="text-right"><a href="{{ cart }}" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> {{ text_cart }}</a>&nbsp;&nbsp;&nbsp;<a href="{{ checkout }}" class="btn btn-primary"><i class="fa fa-share"></i> {{ text_checkout }}</a></p>*/
/*       </div>*/
/*     </li>*/
/*     {% else %}*/
/*     <li>*/
